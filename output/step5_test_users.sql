...
BEGIN
  ...
  VALUES (uid_ceo, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'ceo@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"대표이사"}', now(), now());

  -- [관리부]
  INSERT INTO auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at)
  VALUES 
    (uid_mng_leader, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'mng_leader@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"관리부장"}', now(), now()),
    (uid_mng_1, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'mng1@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"관리직원1"}', now(), now()),
  ...
  INSERT INTO auth.users (id, instance_id, aud, role, email, encrypted_password, email_confirmed_at, raw_app_meta_data, raw_user_meta_data, created_at, updated_at)
  VALUES 
    (uid_sales_leader, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sales_leader@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"영업부장"}', now(), now()),
    (uid_sales_1, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sales1@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"영업직원1"}', now(), now()),
    (uid_sales_2, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sales2@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"영업직원2"}', now(), now()),
    (uid_sales_3, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sales3@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"영업직원3"}', now(), now()),
    (uid_sales_4, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'sales4@test.com', crypt('password', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}', '{"full_name":"영업직원4"}', now(), now());
