      ...
      <Comp
        ...
        className={cn(
          'inline-flex items-center justify-center font-medium rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
          {
            ...
            'border border-[#E5E7EB] bg-white text-[#111827] hover:bg-[#F9FAFB] dark:border-[#4B5563] dark:bg-[#374151] dark:text-[#F1F5F9] dark:hover:bg-[#4B5563]': variant === 'outline',
            'bg-transparent text-[#111827] hover:bg-[#F9FAFB] dark:text-[#F1F5F9] dark:hover:bg-[#4B5563]': variant === 'ghost',
            'bg-[#EF4444] text-white hover:bg-[#dc2626] dark:bg-[#DC2626] dark:hover:bg-[#B91C1C]': variant === 'danger',
            'bg-[#F9FAFB] text-[#111827] hover:bg-[#E5E7EB] dark:bg-[#4B5563] dark:text-[#F1F5F9] dark:hover:bg-[#6B7280]': variant === 'secondary',
          },
          {
