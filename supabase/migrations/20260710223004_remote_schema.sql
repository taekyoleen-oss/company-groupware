...
\restrict Ad53dgfvpRGElfwkVaUVxeGzXVO0hbBLRf6ivfiWyf2tq49TmH9QvncQ02rxFCK
...
--
-- Name: approve_vacation_cancel(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.approve_vacation_cancel(p_cancel_id uuid, p_reviewer_id uuid) RETURNS void
...
--
-- Name: approve_vacation_request(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.approve_vacation_request(p_request_id uuid, p_reviewer_id uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public', 'pg_temp'
    AS $$
DECLARE
...
--
-- Name: current_user_team(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.current_user_team() RETURNS uuid
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
...
--
-- Name: is_current_super_admin(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_current_super_admin() RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
  SELECT COALESCE(
...
--
-- Name: cg_attendance; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_attendance (
...
--
-- Name: COLUMN cg_attendance.checked_out_at; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: cg_company_settings; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_company_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: COLUMN cg_company_settings.require_device_approval; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_event_categories (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name text NOT NULL,
    color text NOT NULL,
...
--
-- Name: cg_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: cg_hr_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_hr_records (
    user_id uuid NOT NULL,
    hire_date date,
    phone text,
...
--
-- Name: cg_message_hides; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_message_hides (
...
--
-- Name: cg_messages; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_messages (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: cg_notice_attachments; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_notice_attachments (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
...
--
-- Name: cg_notices; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_notices (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    title text NOT NULL,
    content text NOT NULL,
...
--
-- Name: cg_office_devices; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_office_devices (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
...
--
-- Name: cg_office_networks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_office_networks (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    cidr text NOT NULL,
    label text,
...
--
-- Name: cg_profiles; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_profiles (
    id uuid NOT NULL,
...
--
-- Name: cg_teams; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_teams (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    name text NOT NULL,
    created_at timestamp with time zone DEFAULT now(),
    abbreviation text,
...
--
-- Name: cg_todos; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_todos (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
    title text NOT NULL,
...
--
-- Name: cg_vacation_allocations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_vacation_allocations (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid NOT NULL,
...
--
-- Name: cg_vacation_cancel_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_vacation_cancel_requests (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    event_id uuid,
...
--
-- Name: cg_vacation_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.cg_vacation_requests (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    requested_by uuid NOT NULL,
    approver_id uuid,
    title text NOT NULL,
...
--
-- Name: cg_attendance cg_attendance_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance cg_attendance_user_id_date_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_company_settings cg_company_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories cg_event_categories_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_events cg_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_hr_records cg_hr_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_message_hides cg_message_hides_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_messages cg_messages_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_notice_attachments cg_notice_attachments_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_notices cg_notices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices cg_office_devices_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices cg_office_devices_user_id_user_agent_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_office_networks cg_office_networks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles cg_profiles_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_teams cg_teams_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_todos cg_todos_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations cg_vacation_allocations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations cg_vacation_allocations_user_id_year_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests cg_vacation_cancel_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests cg_vacation_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests_status_created_at_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_attendance_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_events_created_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_events_is_vacation_partial; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_events_start_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_events_team_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_events_visibility_start_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_messages_recipient_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_messages_sender_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_messages_team_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_notices_created_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_notices_pinned_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_notices_team_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_notices_visibility; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_profiles_approver_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_profiles_is_super_admin; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_teams_sort_order; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_todos_user_sort; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_vacation_requests_approver_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_vacation_requests_requested_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cg_vacation_requests_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_message_hides_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_notice_attachments_notice_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_office_devices_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_office_devices_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_profiles_team_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_vacation_cancel_event_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_vacation_cancel_requested_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_vacation_cancel_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_vacation_requests_event_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance cg_attendance_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories cg_event_categories_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_events cg_events_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_events cg_events_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_events cg_events_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_hr_records cg_hr_records_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_hr_records cg_hr_records_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_message_hides cg_message_hides_message_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_message_hides cg_message_hides_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_messages cg_messages_recipient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_messages cg_messages_sender_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_messages cg_messages_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_notice_attachments cg_notice_attachments_notice_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_notices cg_notices_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_notices cg_notices_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices cg_office_devices_decided_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices cg_office_devices_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_office_networks cg_office_networks_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles cg_profiles_approver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles cg_profiles_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles cg_profiles_team_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_todos cg_todos_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations cg_vacation_allocations_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests cg_vacation_cancel_requests_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests cg_vacation_cancel_requests_requested_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests cg_vacation_cancel_requests_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests cg_vacation_requests_approver_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests cg_vacation_requests_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests cg_vacation_requests_requested_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests cg_vacation_requests_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests Admins can update vacation cancel requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests Users and admins can view vacation cancel requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests Users can create own vacation cancel requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notice_attachments attachments_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notice_attachments attachments_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notice_attachments attachments_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_insert_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_select_admin; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_select_approver; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_select_president_team; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_select_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_select_super_admin; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance attendance_update_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories categories_admin_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories categories_admin_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories categories_admin_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_event_categories categories_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_attendance; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_attendance ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_company_settings; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_company_settings ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_event_categories; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_event_categories ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_events; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_events ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_hr_records; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_hr_records ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_message_hides; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_message_hides ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_messages; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_messages ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_notice_attachments; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_notice_attachments ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_notices; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_notices ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_office_devices; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_office_devices ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_office_networks; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_office_networks ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_profiles; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_profiles ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_teams; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_teams ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_todos; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_todos ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_vacation_allocations; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_vacation_allocations ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_vacation_cancel_requests; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_vacation_cancel_requests ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_vacation_requests; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cg_vacation_requests ENABLE ROW LEVEL SECURITY;

--
-- Name: cg_events events_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_events events_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_events events_select_company; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_events events_select_private; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_events events_select_team; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_events events_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_events events_vacation_approver_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_hr_records hr_records_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_hr_records hr_records_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_message_hides message_hides_delete_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_message_hides message_hides_insert_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_message_hides message_hides_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_messages messages_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_messages messages_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_messages messages_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notices notices_delete; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notices notices_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notices notices_select_company; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notices notices_select_team; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_notices notices_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices office_devices_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices office_devices_delete_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices office_devices_insert_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices office_devices_select_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_devices office_devices_update_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_networks office_networks_admin_write; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_office_networks office_networks_select_authed; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles profiles_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles profiles_select_active; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles profiles_select_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles profiles_update_admin; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_profiles profiles_update_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_company_settings settings_read_active; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_company_settings settings_write_admin; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_teams teams_admin; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_teams teams_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_todos todos_own; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests vac_req_approver_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests vac_req_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests vac_req_self_insert; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_requests vac_req_self_withdraw; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations vacation_alloc_admin_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations vacation_alloc_approver_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations vacation_alloc_approver_write; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_allocations vacation_alloc_select_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests vacation_cancel_approver_select; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cg_vacation_cancel_requests vacation_cancel_approver_update; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION approve_vacation_cancel(p_cancel_id uuid, p_reviewer_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION approve_vacation_request(p_request_id uuid, p_reviewer_id uuid); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION current_user_team(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_active_user(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: FUNCTION is_current_super_admin(); Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_attendance; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_company_settings; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_event_categories; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_events; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_hr_records; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.user_id; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.hire_date; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.phone; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.emergency_contact; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.address; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.updated_at; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.updated_by; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.education; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.career; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.certificates; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_hr_records.hire_position; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_message_hides; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_messages; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_notice_attachments; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_notices; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_office_devices; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_office_devices.last_ip; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_office_devices.last_used_at; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_office_networks; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_profiles; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_profiles.full_name; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_profiles.team_id; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: COLUMN cg_profiles.color; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_teams; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_todos; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_vacation_allocations; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_vacation_cancel_requests; Type: ACL; Schema: public; Owner: -
--
...
--
-- Name: TABLE cg_vacation_requests; Type: ACL; Schema: public; Owner: -
--
...
\unrestrict Ad53dgfvpRGElfwkVaUVxeGzXVO0hbBLRf6ivfiWyf2tq49TmH9QvncQ02rxFCK
